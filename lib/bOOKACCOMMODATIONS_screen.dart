...
class AccommodationScreen extends StatefulWidget {
  ...
  @override
  State<AccommodationScreen> createState() =>
...
class _AccommodationScreenState extends State<AccommodationScreen> {
  ...
  pickDate({required Function(DateTime gg) onPick,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        return isDataLoading.value? SingleChildScrollView(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Padding(
                          ...
                          child: Image.network(
                            model.value.data!.hotelPackageDetails!.packageImage.toString(),
                            width: 125.0,
                          ),
                        ),
                      ),
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text.rich(
                              TextSpan(
                                children: [
                                  TextSpan(
                                    text:
                                    model.value.data!.hotelPackageDetails!.packageDescription.toString().substring(0,150),
                            ...
                            InkWell(
                              onTap: () async {
                                final String url = model.value.data!.hotelPackageDetails!.packageButtonUrl.toString();
                              ...
                              child: Container(
                                ...
                                child: Center(
                                    child: Text(
                                      model.value.data!.hotelPackageDetails!.packageButtonName.toString(),
                ...
                Text(
                  model.value.data!.whistlerLodgingDetails!.lodgingTitle.toString(),
                ...
                Text(
                  model.value.data!.whistlerLodgingDetails!.lodgingDescription.toString(),
                  style: GoogleFonts.robotoSlab(
                    fontSize: 11.0,
                    color: Colors.black,
                    fontWeight: FontWeight.w300,
                        ...
                        InkWell(
                          ...
                          child: SizedBox(
                            ...
                            child: RegisterTextFieldWidget(
                                ...
                                readOnly: true,
                                hint: model.value.data!.searchLodging!.arrivaldate,
                                onTap: () {}),
                          ),
                        ),
                      ],
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: RegisterTextFieldWidget(
                              ...
                              readOnly: true,
                              hint: model.value.data!.searchLodging!.departuredate,
                              onTap: () {}),
                        ),
                      ],
                    )
                ...
                InkWell(
                  onTap: () async {
                    final String url = model.value.data!.searchLodging!.searchUrl.toString();
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return Container(
                          ...
                          child: Center(
                              child: Text(
                                model.value.data!.accommodationsMenu![index].menuTitle.toString(),                                style: GoogleFonts.roboto(
                                  fontSize: 10,
                                  color: Colors.white,
                                  fontWeight: FontWeight.w600,
                                ),
